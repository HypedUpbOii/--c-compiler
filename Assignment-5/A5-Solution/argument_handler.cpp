...
const char *argp_program_bug_address =
    "<23b1006@iitb.ac.in/23b1073@iitb.ac.in>";
...
error_t ArgumentHandler::parse_opt(int key, char *arg,
...
argp ArgumentHandler::argp = {options, parse_opt, args_doc, doc};

ArgumentHandler::ArgumentHandler(int argc, char *argv[]) {
    argp_parse(&argp, argc, argv, ARGP_IN_ORDER, 0, this);
}

const Arguments &ArgumentHandler::return_arguments() const { return args; }
