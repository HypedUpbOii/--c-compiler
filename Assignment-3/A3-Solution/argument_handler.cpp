...
argp_option ArgumentHandler::options[] = {
    ...
    {"sa-ast", 1002, 0, 0, "Stop after constructing Abstract Syntax Tree (AST)"},
    {"show-tokens", 1003, 0, 0, "Show the tokens in FILE.toks (or out.toks)"},
    {"show-ast", 1004, 0, 0, "Show abstract syntax trees in FILE.ast (or out.ast)"},
    {"show-tac", 1005, 0, 0, "Show the Three Address Code in FILE.tac (or out.tac)"},
