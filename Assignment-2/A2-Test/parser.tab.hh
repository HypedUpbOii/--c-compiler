...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    GREATER_THAN_EQUAL = 269,      // GREATER_THAN_EQUAL
    ...
    OR = 274,                      // OR
    NOT = 275,                     // NOT
    ADDRESSOF = 276,               // ADDRESSOF
    SEMICOLON = 277,               // SEMICOLON
    COMMA = 278,                   // COMMA
    LEFT_ROUND_BRACKET = 279,      // LEFT_ROUND_BRACKET
    RIGHT_ROUND_BRACKET = 280,     // RIGHT_ROUND_BRACKET
    LEFT_CURLY_BRACKET = 281,      // LEFT_CURLY_BRACKET
    RIGHT_CURLY_BRACKET = 282,     // RIGHT_CURLY_BRACKET
    QUESTION_MARK = 283,           // QUESTION_MARK
    COLON = 284,                   // COLON
    INTEGER = 285,                 // INTEGER
    BOOL = 286,                    // BOOL
    VOID = 287,                    // VOID
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_MULT = 9,                              // MULT
        S_DIV = 10,                              // DIV
        S_ASSIGN_OP = 11,                        // ASSIGN_OP
        S_GREATER_THAN = 12,                     // GREATER_THAN
        S_LESS_THAN = 13,                        // LESS_THAN
        S_GREATER_THAN_EQUAL = 14,               // GREATER_THAN_EQUAL
        S_LESS_THAN_EQUAL = 15,                  // LESS_THAN_EQUAL
        S_EQUAL = 16,                            // EQUAL
        S_NOT_EQUAL = 17,                        // NOT_EQUAL
        S_AND = 18,                              // AND
        S_OR = 19,                               // OR
        S_NOT = 20,                              // NOT
        S_ADDRESSOF = 21,                        // ADDRESSOF
        S_SEMICOLON = 22,                        // SEMICOLON
        S_COMMA = 23,                            // COMMA
        S_LEFT_ROUND_BRACKET = 24,               // LEFT_ROUND_BRACKET
        S_RIGHT_ROUND_BRACKET = 25,              // RIGHT_ROUND_BRACKET
        S_LEFT_CURLY_BRACKET = 26,               // LEFT_CURLY_BRACKET
        S_RIGHT_CURLY_BRACKET = 27,              // RIGHT_CURLY_BRACKET
        S_QUESTION_MARK = 28,                    // QUESTION_MARK
        S_COLON = 29,                            // COLON
        ...
        S_var_list = 41,                         // var_list
        S_func_decl = 42,                        // func_decl
        S_func_header = 43,                      // func_header
        S_func_def = 44,                         // func_def
        S_formal_param_list = 45,                // formal_param_list
        S_formal_param = 46,                     // formal_param
        S_param_type = 47,                       // param_type
        S_statement_list = 48,                   // statement_list
        S_statement = 49,                        // statement
        S_optional_var_decl_stmt_list = 50,      // optional_var_decl_stmt_list
        S_var_decl_stmt_list = 51,               // var_decl_stmt_list
        S_var_decl_stmt = 52,                    // var_decl_stmt
        S_var_decl_item_list = 53,               // var_decl_item_list
        S_named_type = 54,                       // named_type
        S_assignment_statement = 55,             // assignment_statement
        S_print_statement = 56,                  // print_statement
        S_read_statement = 57,                   // read_statement
        S_expression = 58,                       // expression
        S_rel_expression = 59,                   // rel_expression
        S_constant_as_operand = 60               // constant_as_operand
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INT_NUM (int v, location_type l)
      {
        return symbol_type (token::INT_NUM, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_INT_NUM (const int& v, const location_type& l)
      {
        return symbol_type (token::INT_NUM, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_FLOAT_NUM (float v, location_type l)
      {
      ...
      static
      symbol_type
      make_FLOAT_NUM (const float& v, const location_type& l)
      {
      ...
      {
        return symbol_type (token::STR_CONST, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::STR_CONST, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ASSIGN_OP (location_type l)
      {
        return symbol_type (token::ASSIGN_OP, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_GREATER_THAN_EQUAL (location_type l)
      {
        return symbol_type (token::GREATER_THAN_EQUAL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::GREATER_THAN_EQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LESS_THAN_EQUAL (location_type l)
      {
        return symbol_type (token::LESS_THAN_EQUAL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LESS_THAN_EQUAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ADDRESSOF (location_type l)
      {
        return symbol_type (token::ADDRESSOF, std::move (l));
      }
#else
      static
      symbol_type
      make_ADDRESSOF (const location_type& l)
      {
        return symbol_type (token::ADDRESSOF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LEFT_ROUND_BRACKET (location_type l)
      {
        return symbol_type (token::LEFT_ROUND_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_LEFT_ROUND_BRACKET (const location_type& l)
      {
        return symbol_type (token::LEFT_ROUND_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_ROUND_BRACKET (location_type l)
      {
        return symbol_type (token::RIGHT_ROUND_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHT_ROUND_BRACKET (const location_type& l)
      {
        return symbol_type (token::RIGHT_ROUND_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LEFT_CURLY_BRACKET (location_type l)
      {
        return symbol_type (token::LEFT_CURLY_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LEFT_CURLY_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_CURLY_BRACKET (location_type l)
      {
        return symbol_type (token::RIGHT_CURLY_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::RIGHT_CURLY_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_QUESTION_MARK (location_type l)
      {
        return symbol_type (token::QUESTION_MARK, std::move (l));
      }
#else
      static
      symbol_type
